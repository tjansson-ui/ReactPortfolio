...
const Resume = () => {
    return (
      <>
        <img src="/assets/opossumhero.png" className="img-fluid w-25" alt="resume stock photo" />
        <h2>Resume</h2>
        <p>You found the resume page! This is a work in progress. </p>
        <Link to="/assets/Resume_Current.pdf" target="_blank" download>Download a pdf here!</Link>
